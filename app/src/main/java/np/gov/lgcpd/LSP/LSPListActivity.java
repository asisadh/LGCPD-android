 ...
 */
public class LSPListActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    private void populateTheList(String value){
        ...
        String URL = Constants.LSP_API + this.value + "/" +  name;
    ...
    private class GetSM extends AsyncTask<String, Integer, JSONArray>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd = new ProgressDialog(LSPListActivity.this);
        ...
        protected void onPostExecute(JSONArray jsonArray) {
            ...
            if(jsonArray != null)
                for(int i = 0; i < jsonArray.length(); i++){
                    try {
                        ...
                        String phone = jo.getString("office_phone");
                        String address = jo.getString("address");
                        String vdc = jo.getString("contact_email");
            ...
            adapter = new CardViewAdapterForLSPList(getApplicationContext(), list);
